"""
Tests for the playcua Python bindings.
...
try:
    from playcua import Computer  # type: ignore
except ImportError:
    pytest.skip("playcua package not installed — skipping integration tests", allow_module_level=True)
